...
//jobSize = {1, 3, 5, 7, 9, 11, 10, 8, 6, 4}, p = 7	11
    @Test
    public void testFinalLoad6(){
        int[] jobSize = {1, 3, 5, 7, 9, 11, 10, 8, 6, 4};
        int processors = 7;
        assertEquals(LoadBalancing.findLoad(jobSize, processors), 11);
    }

    @Test
    public void testFinalLoad7(){
        int[] jobSize = {1, 3, 5, 7, 9, 11, 10, 8, 6, 4};
        int processors = 1;
